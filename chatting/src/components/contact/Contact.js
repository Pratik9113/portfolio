...
const Contact = () => {
    ...
    return (
        ...
        <div className="both-contact">
            ...
            <div className='ach'>
                <h2 className='col-12 mb-1 text-center'>Contact</h2>
                <hr className='line' />
                <p className='pb-3 text-center'>Here is my Contact</p>
            </div>
                <div className="row1">
                    <div className="col">
        ...
        <div className="container input-contact" id ="Contact">
            <div className="contact-input">
                ...
                <div className="row px-3 mb-4">
                    <form action = "https://formspree.io/f/xdoqnjeg" method = "POST" >
                <div className='row px-3'>
                    <input type='text' name = 'username' placeholder='Enter your name' className='mb-3' required autoComplete="off" 
                    /*value = {name} onChange={(e)=>setname(e.target.value)}*//>
                </div>
                <div className='row px-3'>
                    <input type='email' name = 'email' placeholder='Enter your Email Id' className='mb-3' required autoComplete="off"
                    /* value = {email}  onChange={(e)=>setemail(e.target.value)}*//>
                </div>
                <div className='row px-3'>
                    <textarea type='text' name = 'msg' placeholder='Write your message' className='mb-3' required autoComplete="off"
                    /* value ={msg} onChange={(e)=>setmsg(e.target.value)}*//>
                </div>
                <div className='row px-3'>
                    <button className='button'  type='submit' value ="send"
                    /*onClick={handleSubmit}*/> Send Msg</button>
                </div>
                </form>
                </div>
                </div>
